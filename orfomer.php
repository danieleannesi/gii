...
<script type="text/javaScript" src="orfomer.js"></script>
...
<input id="ord_cliente" name="ord_cliente" type="hidden">
...
<input type="button" value="Carica" onclick="leggi_documento();">
</td>

<td>
<label for="data_ric">Data ddt</label>
<input id="data_ddt" name="data_ddt" type="text" size="11" maxlength="11" value="<?php echo $data?>" onChange="check_date(data_ddt);">
          <script  type="text/javascript">
        new tcal ({
                // form name
                'formname': 'documenti',
                // input name
                'controlname': 'data_ddt'
        });
        </script>
</td>
<td>
<label for="nume_ddt">Numero</label>
<input id="nume_ddt" name="nume_ddt" type="text" size="8">
</td>
<td>
<label for="data_car">Data Carico</label>
<input id="data_car" name="data_car" type="text" size="11" maxlength="11" value="<?php echo $data?>" onChange="check_date(data_car);">
          <script  type="text/javascript">
        new tcal ({
                // form name
                'formname': 'documenti',
                // input name
                'controlname': 'data_car'
        });
        </script>
</td>
...
<input id="fornitore" name="fornitore" type="text"size="9" maxlength="8">
</td>
<td>
<input name="ragsoc"  id="ragsoc" type="text" size="90">
</td>
</tr>
</table>
<table class="testata">
...
<input id="installazione" name="installazione" type="number" step=".01" onblur="calcola_totali();disegna_totali();"><br>
...
<input id="collaudo" name="collaudo" type="number" step=".01" onblur="calcola_totali();disegna_totali();"><br>
...
<input id="addvari" name="addvari" type="number" step=".01" onblur="calcola_totali();disegna_totali();"><br>

<label for="des_spedizione" class="dx10">Spedizione</label>
<input id="des_spedizione" name="des_spedizione" type="text" size="50"><br>
<label for="des_trasporto" class="dx10">Trasporto</label>
<input id="des_trasporto" name="des_trasporto" type="text" size="50"><br>
<label for="des_imballo" class="dx10">Imballo</label>
<input id="des_imballo" name="des_imballo" type="text" size="50"><br>
...
<tr>
<td>
<input type="text" id="codart" name="codart" size="10" placeholder="codice articolo" readonly>
</td>
<td>
<textarea id="desart" name="desart" placeholder="descrizione articolo" rows="1" cols="80" readonly>
</textarea>
...
<td><input class="acapo" name="OK" type="button" value="Salva Riga" onClick="calcolar();salvariga();"></td>
</tr>
</table>
<table width="916">
<tr>
<td width="64" align="right" class="labelit">Ord</td>
<td>
<input id="indice" name="indice" type="hidden">	
<input id="quantita" name="quantita" class="piccolo" type="number" step=".01" readonly>
</td>
<td width="64" align="right" class="labelit">Sca</td>
<td>
<input id="qua_sca" name="qua_sca" class="piccolo" type="number" step=".01" readonly>
</td>
<td width="64" align="right" class="labelit">Ric</td>
<td>
<input id="qua_ric" name="qua_ric" class="piccolo" type="number" step=".01" onBlur="calcolar()">
</td>
<td width="65" align="right" class="labelit">Unit.</td>
<td><input id="prezzo" name="prezzo" class="piccolo" type="number" step=".0001"  readonly></td>
<td width="65" align="right" class="labelit">Sconto</td>
<td><input id="sconto" name="sconto" class="piccolo" type="number" step=".01" readonly></td>
<td width="59" align="right" class="labelit">Tot</td>
<td><input id="totale" name="totale" class="piccolo" type="number" step=".01" readonly></td>

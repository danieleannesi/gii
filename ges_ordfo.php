...
<script type="text/javaScript" src="ges_ordfo.js"></script>
...
<input id="fornitore" name="fornitore" type="text"size="9" maxlength="8" value="<?php echo $fornitore?>" readonly onchange="carica_fornitore(this);">
</td>
<td>
